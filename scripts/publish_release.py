#!/usr/bin/env python3
"""Prepare a Mise en Place Assistant release by updating versioned files."""
...
MANIFEST = ROOT / "custom_components" / "mise_en_place_assistant" / "manifest.json"
...
def main() -> int:
    ...
    print(f"Mise en Place Assistant version: {old_version} -> {version}")
